...
import com.bootdo.lucene.util.DocumentUtil;
import com.bootdo.lucene.util.IKAnalyzer5x;
import com.bootdo.lucene.util.PathUtil;
import com.bootdo.lucene.util.QueryUtil;
...
public class LuceneDao {
	...
	public Directory getDirectory() throws IOException {
		if(directory == null){
			this.setIndexDer("D:\\hulu\\webappchat\\bootdo\\luence");
