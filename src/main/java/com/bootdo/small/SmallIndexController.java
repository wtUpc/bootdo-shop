...
public class SmallIndexController {
	...
	public R brandGoods(@RequestParam Map<String, Object> params,HttpServletRequest req) {
		...
		try {
			Query query = new Query(params);
			List<TGoodsDO> tBrandList = tGoodsService.list(query);
	...
	public R category(@RequestParam Map<String, Object> params) {
		...
		try {
			Query query = new Query(params);
			List<TGoodsTypeDO> tCategoryList = tGoodsTypeService.list(query);
			int total = tGoodsTypeService.count(query);
			PageUtils pageUtils = new PageUtils(tCategoryList, total);
...
//	get_qrcode: _api_root + 'order/get-qrcode',
	...
	public R commentList(@RequestParam Map<String, Object> params){
		...
		try {
			Query query = new Query(params);
			List<TReplyDO> treplyleList = tReplyService.list(query);
			int total = tReplyService.count(query);
			PageUtils pageUtils = new PageUtils(treplyleList, total);
			r.put("data",pageUtils);
		}catch (Exception e){
			e.printStackTrace();
			return R.error();
	...
	public R addressList(@RequestParam Map<String, Object> params){
		...
		try {
			Query query = new Query(params);
			List<AddressDO> taddressList = addressService.list(query);
			int total = addressService.count(query);
			PageUtils pageUtils = new PageUtils(taddressList, total);
			r.put("data",pageUtils);
		}catch (Exception e){
			e.printStackTrace();
			return R.error();
...
//	favorite_list: _api_root + "user/favorite-list",
	...
	public R goodsfavoriteList(@RequestParam Map<String, Object> params){
		...
		try {
			Query query = new Query(params);
			List<FavoriteDO> tfavoriteList = favoriteService.userFavorite(query);
			r.put("data",tfavoriteList);
		}catch (Exception e){
			e.printStackTrace();
			return R.error();
		}
	...
	public R topicfavoriteList(@RequestParam Map<String, Object> params){
		...
		try {
			Query query = new Query(params);
			List<FavoriteDO> tfavoriteList = favoriteService.userTopicFavorite(query);
			r.put("data",tfavoriteList);
		}catch (Exception e){
			e.printStackTrace();
			return R.error();
...
//	topic_favorite_list: _api_root + "user/topic-favorite-list",
	...
	public R topicList(@RequestParam Map<String, Object> params){
		...
		try {
			Query query = new Query(params);
			List<TopicDO> ttopicList = topicService.list(query);
			int total = topicService.count(query);
			PageUtils pageUtils = new PageUtils(ttopicList, total);
			r.put("data",pageUtils);
		}catch (Exception e){
			e.printStackTrace();
			return R.error();
	...
	public R couponList(@RequestParam Map<String, Object> params){
		...
		try {
			Query query = new Query(params);
			List<CouponDO> tCouponList = couponService.list(query);
			int total = couponService.count(query);
			PageUtils pageUtils = new PageUtils(tCouponList, total);
			r.put("data",pageUtils);
		}catch (Exception e){
			e.printStackTrace();
			return R.error();
	...
	public R userCoupon(@RequestParam Map<String, Object> params){
		...
		try {
			Query query = new Query(params);
			List<CouponDO> tCouponList = couponService.userCoupon(query);
			int total = couponService.count(query);
			PageUtils pageUtils = new PageUtils(tCouponList, total);
			r.put("data",pageUtils);
		}catch (Exception e){
