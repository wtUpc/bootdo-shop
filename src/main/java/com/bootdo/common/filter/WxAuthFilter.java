package com.bootdo.common.filter;


import com.bootdo.common.utils.SessionUtil;
import com.bootdo.config.WxConfigProperties;
...
public class WxAuthFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException,
     ...
     //   logger.info("doFilter getHeadersInfo:{}",getHeadersInfo(httpServletRequest));
        ...
        UserDO user = sessionUtil.getCurrentUser();
        ...
        if (uri.startsWith(Constant.WX_H5_URI) && null == user
            ...
            //处理用户
            try {
                user = userService.getByWxOauthCode(wxOauth2Code);
                ...
                if (null == uid || uid <= 0) {
                    ...
                    String toUrl = wxConfigProperties.getPageDomain() + "/taobao/index" + "?token=" + user.getToken();
